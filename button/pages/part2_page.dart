        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                const Text('Custom Switch', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                CustomSwitch(
            ...
            Row(
              children: [
                const Text('Custom Checkbox:', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
            ...
            // Radio
            const Text('Custom Radio', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
            const SizedBox(height: 1),
            CustomRadio<String>(
              value: 'Option 1',
  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            const Text('Custom Slider', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
            const SizedBox(height: 1),
            CustomSlider(
  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            const Text('Custom InkWell', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
            const SizedBox(height: 10),
            CustomInkWell(
              label: 'Nhấn vào đây',
              onTap: () => setState(() => _status = 'Tap'),
